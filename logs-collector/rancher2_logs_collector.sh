#!/bin/bash
# Kubernetes logs collector for supported Linux distributions
# Maintained by Mattox Engineering
# Supports RKE2, RKE1, K3s, and kubeadm clusters
...
help() {
  ...
  echo "Kubernetes logs-collector (Mattox Engineering)
